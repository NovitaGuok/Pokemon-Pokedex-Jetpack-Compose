package com.phincon.pokemonapp.novita.presentation.my_pokemon.component.list_item
        ...
        ConstraintLayout {
            ...
            IconButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.img_desc_delete),
                    tint = Color.White
                )
            }
            Image(
            ...
            Text(
                ...
                text = stringResource(R.string.txt_my_pokemon_owned, data.owned),
                style = textRegular14
            )
        }
    }
